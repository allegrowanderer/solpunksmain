...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-cover bg-center" style={{backgroundImage: "url('/runesbg.png')" , backgroundSize: '40%' }}>
      {copySuccess && (
      ...
      <main className="flex flex-col lg:flex-row items-start justify-center flex-grow p-4 text-white">
        <div className="w-full max-w-md bg-teal-500 text-black rounded-lg shadow-md p-8 space-y-4 mt-0 lg:mt-10 border-4 border-black">
          <h2 className="text-2xl font-bold text-center font-runes mb-4 " style={{ fontSize: '300%', marginTop: '23px' }}>PRESALE IS LIVE!</h2>
          <input
            type="text"
            value={amount}
          ...
          <div className="mt-4 progress-container relative">
            <div className="h-8 w-full bg-gray-200 border-black border-4">
              ...
              ></div>
              <p className="absolute inset-0 flex items-center justify-center font-runes text-[#000000] mb-2" style={{ top: '25%' , fontSize: '120%' }}>RAISED OF 1000 SOL GOAL</p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center lg:ml-[5cm] mt-0 lg:mt-10 relative">
          <div className="w-full max-w-md bg-teal-500 text-black rounded-lg shadow-md p-7 space-y-4 border-4 border-black relative">
            ...
            <h2 className="text-5xl font-bold text-center font-runes mt-12" style={{ fontSize: '300%' }}>JOIN NOW</h2>
            <p className="text-center font-runes" style={{ fontSize: '118%', marginTop: '30px' , marginBottom: '35px' }}>
              10% OF PUNK’S TOTAL SUPPLY WILL BE AIRDROPPED FOR FREE TO EVENT PARTICIPANTS. TO JOIN THE AIRDROP, COMPLETE THE TWO SPECIFIED TASKS. TOKENS WILL BE SENT TO YOUR WALLET AFTER THE PRESALE CONCLUDES.
            </p>
            <div className="flex items-center justify-center space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#000000] text-white rounded-full w-3/5 font-runes" style={{ fontSize: '130%' }}
              >
                Follow @RunesPunks
              </button>
            </div>
            ...
            <div className="flex items-center justify-center mt-2">
              <button
                ...
                className="px-2 py-1 bg-[#000000] text-white rounded-full w-1/3 ml-4 font-runes" style={{ fontSize: '130%' }}> 
                Submit
              </button>
            </div>
            <Image src="/solpunksborder.png" alt="SolPunks Photo" width={145} height={145} className="absolute top-[-35px] right-[-28px]" />
          </div>
        </div>
      </main>
      ...
      <main className="flex flex-col items-center justify-center flex-grow p-4 text-white">
        <div id="about" className="w-full max-w-4xl bg-teal-500 text-black rounded-lg shadow-md p-8 space-y-4 mt-10 border-4 border-black">
          <h2 className="text-2xl font-bold text-center font-runes" style={{ fontSize: '230%' }}>
            WHAT IS <span className="text-[#9333EA]" style={{ fontSize: '130%' }}>$PUNK</span>?
          </h2>
          <p className="text-xl font-runes">
          $PUNK is first token for SolPunks! $PUNK is a playful and community-driven token. We believe in the collective strength and creativity of our members to drive the project forward.
Our token is not just about financial opportunity but also about embracing the fun and irreverence that memecoins bring to the cryptocurrency landscape.
Offering thrill-seeking investors a wild ride! Join the PUNK community to grow and leave your worries behind. 
The total supply of $PUNK tokens is 250 million. With 10% allocated for marketing, 50% for liquidity pools (LP), and 40% for airdrops. 
Participate in the $PUNK Presale and watch your investment grow!
          </p>
        </div>
        <div id="how-to-buy" className="w-full max-w-4xl bg-teal-500 text-black rounded-lg shadow-md p-8 space-y-4 mt-10 border-4 border-black">
          <h2 className="text-2xl font-bold text-center font-runes" style={{ fontSize: '230%' }}>
            HOW TO BUY <span className="text-[#9333EA]" style={{ fontSize: '130%' }}>$PUNK</span>?
          </h2>
          <p className="text-xl font-runes">
            1. CLICK ON THE “BUY NOW” BUTTON ABOVE.<br/><br/>
            2. ENTER THE AMOUNT OF SOL TO SWAP FOR $PUNK.<br/><br/>
          ...
          <p className="text-xl font-runes text-center text-[#9333EA]" style={{ fontSize: '170%' }}>
      ...
      <footer className="p-4 bg-teal-500 text-center">
        <p className="text-sm font-runes">&copy; 2024 SolPunks on Solana. All rights reserved.</p>
      </footer>
    </div>
  );
}
